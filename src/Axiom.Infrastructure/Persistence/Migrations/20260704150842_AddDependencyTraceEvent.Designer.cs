...
namespace Axiom.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260704150842_AddDependencyTraceEvent")]
    partial class AddDependencyTraceEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.ComponentDependency", b =>
                {
                    ...
                    b.HasIndex("SourceComponentId", "TargetComponentId", "DependencyType")
                        .IsUnique()
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.DependencyTraceEvent", b =>
                {
                    ...
                    b.Property<string>("RelatedChangeNumber")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
                    ...
                    b.Property<Guid?>("RelatedKnowledgeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("RelatedRitmNumber")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");

                    b.HasKey("TraceEventId");
                    ...
                    b.HasIndex("RelatedKnowledgeId")
                        .HasDatabaseName("IX_DependencyTraceEvents_RelatedKnowledgeId");

                    b.ToTable("DependencyTraceEvents", (string)null);
                });
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.SystemComponent", b =>
                {
                    b.Property<Guid>("SystemComponentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SystemId", "ComponentId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.TechnicalComponent", b =>
                {
                    b.Property<Guid>("ComponentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TechnicalComponents", (string)null);
                });
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.ComponentDependency", b =>
                {
                    b.HasOne("Axiom.Domain.Entities.TechnicalComponent", "Source")
                        .WithMany("OutgoingDependencies")
                        .HasForeignKey("SourceComponentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Axiom.Domain.Entities.TechnicalComponent", "Target")
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.DependencyTraceEvent", b =>
                {
                    b.HasOne("Axiom.Domain.Entities.ComponentDependency", "Dependency")
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.SystemComponent", b =>
                {
                    b.HasOne("Axiom.Domain.Entities.TechnicalComponent", "Component")
            ...
            modelBuilder.Entity("Axiom.Domain.Entities.AxiomSystem", b =>
                {
                    ...
                    b.Navigation("TechnicalComponents");
                });
